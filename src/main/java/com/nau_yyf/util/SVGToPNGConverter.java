...
public class SVGToPNGConverter {
    ...
    public static void main(String[] args) {
        // 设置图片资源根目录
        String resourceDir = "src/main/resources/images/tanks/enemy/elite";
        ...
        try {
            ...
            System.out.println("所有SVG文件转换完成！");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private static void convertSVGToPNG(Path svgPath) throws Exception {
        ...
        System.out.println("转换: " + svgPath + " -> " + pngPath);
        ...
        // 设置高质量参数（使用正确的常量名）
        // 高像素密度可确保图像清晰
        transcoder.addTranscodingHint(PNGTranscoder.KEY_PIXEL_UNIT_TO_MILLIMETER, 0.084667f / 4.0f); // 相当于约300 DPI
        
        // 设置输出图像尺寸（如果需要特定尺寸）
        // 对于小图标，可以设置更大的宽高以确保清晰度
        float width = 400; // 足够大以确保清晰
        float height = 400;
