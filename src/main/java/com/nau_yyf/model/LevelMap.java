...
public class LevelMap {
    ...
    public static class EnemySpawn {
        ...
        public MapPosition getSpawnPoint() {
            return spawnPoint;
        }

        public void setSpawnPoint(MapPosition spawnPoint) {
    ...
    public MapPosition getPlayerBase() {
        return playerBase;
    }

    public void setPlayerBase(MapPosition playerBase) {
        this.playerBase = playerBase;
    }

    public MapPosition getPlayerSpawn() {
        return playerSpawn;
    }
