 ...
 * 双人游戏模式选择界面
 */
public class MultiPlayerModeSelectionView extends BaseMenuView {
     ...
     * @param stage 主舞台
     */
    public MultiPlayerModeSelectionView(GameView gameView, StackPane root, Stage stage) {
    ...
    public void show() {
        Platform.runLater(() -> {
            ...
            // 界面标题（使用基类方法）
            optionsContainer.getChildren().add(createTitle("双人游戏模式"));
            ...
            JFXButton campaignButton = createMenuButton("闯关模式", e -> 
                gameView.showGameOptions(GameView.GAME_MODE_MULTI_CAMPAIGN));
            
            JFXButton vsButton = createMenuButton("对战模式", e -> 
                gameView.showGameOptions(GameView.GAME_MODE_MULTI_VS));
            
            JFXButton endlessButton = createMenuButton("无尽模式", e -> 
                gameView.showGameOptions(GameView.GAME_MODE_MULTI_ENDLESS));
            ...
            // 提示标签
            Label tipLabel = new Label("提示: 选择你和朋友想要体验的游戏模式");
